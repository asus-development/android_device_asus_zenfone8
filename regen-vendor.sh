...
VENDOR_SKIP_FILES_COMMON=(
    ...
    "etc/audio/sku_lahaina/audio_effects.conf"
    "etc/audio/sku_lahaina/audio_effects.xml"
    "etc/audio/sku_lahaina/audio_io_policy.conf"
    "etc/audio/sku_lahaina/audio_platform_info.xml"
    "etc/audio/sku_lahaina/audio_platform_info_hdk.xml"
    "etc/audio/sku_lahaina/audio_platform_info_intcodec.xml"
    "etc/audio/sku_lahaina/audio_platform_info_qrd.xml"
    "etc/audio/sku_lahaina/audio_policy_configuration.xml"
    "etc/audio/sku_lahaina/audio_policy_volumes.xml"
    "etc/audio/sku_lahaina/audio_tuning_mixer.txt"
    "etc/audio/sku_lahaina/default_volume_tables.xml"
    "etc/audio/sku_lahaina/mixer_paths.xml"
    "etc/audio/sku_lahaina/mixer_paths_cdp.xml"
    "etc/audio/sku_lahaina/mixer_paths_hdk.xml"
    "etc/audio/sku_lahaina/mixer_paths_hhg.xml"
    "etc/audio/sku_lahaina/mixer_paths_qrd.xml"
    "etc/audio/sku_lahaina/r_submix_audio_policy_configuration.xml"
    ...
    "etc/audio/sku_lahaina/sound_trigger_platform_info.xml"
    ...
    "lib/hw/gralloc.qti.so"
    "lib64/hw/gralloc.qti.so"
